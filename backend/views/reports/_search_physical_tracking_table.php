...
<?php
if (!empty($_GET['AwpbActivityLineSearch']['province_id'])) {
    $model->province_id = $_GET['AwpbActivityLineSearch']['province_id'];
}
if (!empty($_GET['AwpbActivityLineSearch']['district_id'])) {
    $model->district_id = $_GET['AwpbActivityLineSearch']['district_id'];
}
if (!empty($_GET['AwpbActivityLineSearch']['year'])) {
    $model->year = $_GET['AwpbActivityLineSearch']['year'];
}
...
<div class="row" style="">
    ...
    $model->isNewRecord = !empty($_GET['AwpbActivityLineSearch']['province_id']) ? false : true;
    ...
    if (isset($_GET['AwpbActivityLineSearch']['year']) && !empty($_GET['AwpbActivityLineSearch']['year'])) {
