    ...
    <div class="card-body">
        <div class="tab-content" id="custom-tabs-two-tabContent">
            <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                <h5>Instructions</h5>
                <ol>
                    <li>Form below allows you to upload Back to Office media<code>(Image, videos)</code>
                    </li>
                ...
                $form = ActiveForm::begin([
                            'action' => 'update-media?id=' . $model->id . '&id1=' . $model2->id . '&type=' . $type,
                            'fieldConfig' => [
                                'options' => [
