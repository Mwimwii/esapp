...
$this->title = 'Logframe / Output 4P MGF Financed services records';
...
$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne([
            'record_type' => "People receiving services - Number",
            'indicator' => "People receiving services, financed through 4P matching grants"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label>People receiving services, financed through 4P matching grants</li>
            <li>
                Log framework Programme target - 4P MGF Financed services - Number of People
                <ul>
                    <?php
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                        ...
                        'filename' => 'logframe_output_people_4p_financed_services',
                        'dropdownOptions' => [
