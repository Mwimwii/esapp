...
$this->title = 'Logframe / Output Services MGF Financed records';
$this->params['breadcrumbs'][] = $this->title;
$Baseline = 0;
$mid_target = 0;
$end_target = 0;

$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne(['record_type' => "People receiving services - Number", 'indicator' => "People receiving services, financed through the MSME MG"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label> People receiving services, financed through the MSME MG </li>
            <li>
                Log framework Programme target - People receiving services - Number
                <ul>
                    <?php
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                        ...
                        'filename' => 'logframe_output_people_services_msmemg_financed',
                        'dropdownOptions' => [
