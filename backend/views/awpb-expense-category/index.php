...
/* @var $searchModel backend\models\AwpbExpenseSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'AWPB Expense Categories';
    ...
    <div class="card-body">
        ...
        <p>
           ...
           if (User::userIsAllowedTo("Setup AWPB") ) {
               echo Html::a('<i class="fa fa-plus"></i> Add AWPB Expense Category', ['create'], ['class' => 'btn btn-success btn-sm']);
            }
            ?>
        </p>
                        ...
                        'view' => function ($url, $model) {
                            if (User::userIsAllowedTo('View AWPB') && User::STATUS_ACTIVE) {
                                return Html::a(
                                            ...
                                            'title' => 'View AWPB Expense Category',
                                            'data-toggle' => 'tooltip',
                                            'data-placement' => 'top',
                                            'data-pjax' => '0',
                                            'style' => "padding:5px;",
                        ...
                        'update' => function ($url, $model) {
                            if (User::userIsAllowedTo('Setup AWPB') ) {
                                return Html::a(
                                            ...
                                            'title' => 'Update AWPB Exapense Category',
                                            'data-toggle' => 'tooltip',
                                            'data-placement' => 'top',
                                            // 'target' => '_blank',
                                            'data-pjax' => '0',
                        ...
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Setup AWPB') ) {
                                return Html::a(
                                            ...
                                            'title' => 'Delete AWPB Expense Category',
                                            'data-toggle' => 'tooltip',
                                            'data-placement' => 'top',
                                            'data' => [
