...
/* @var $searchModel backend\models\LogframeHouseholdMembersSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Logframe / Project Goal improved diet';
...
$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne(['record_type' => "women-improved quality - Percentage", 'indicator' => "1.2.8 (Number) Percentage of women reporting improved quality of their diets"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label>  1.2.8 (Number) Percentage of women reporting improved quality of their diets</li>
            <li>
                Log framework Programme target -  Women reporting improved Diet(%)
                <ul>
                    <?php
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                      ...
                      //  'pjaxContainerId' => 'kv-pjax-container',
                        ...
                        'filename' => 'logframe_project_goal_improved_diet',
                        'dropdownOptions' => [
