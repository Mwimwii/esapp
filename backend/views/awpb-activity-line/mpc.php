...
// }
       ...
       $gridColumns = [
        ...
        [
            ...
            'label' => 'District',
            'value' => function ($model) {
                return !empty($model->district_id) && $model->district_id > 0 ?  Html::a(backend\models\Districts::findOne($model->district_id)->name,['awpb-activity-line/mpcd','id' => $model->district_id], ['class' => 'awbp-activity-line']):"";
                ;
            },
        //     'visible' => !empty($model->district_id) && $model->district_id > 0 ? TRUE : FALSE,
         ],
