...
<div class="card card-success card-outline">
    ...
    <p>
            ...
            <?php
             echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['mpwpcoa', 'id' =>$model->activity_id,'id2'=> $model->awpb_template_id], [
                'title' => 'back',
                'data-toggle' => 'tooltip',
                'data-placement' => 'top',
            ]);
           // if (\backend\models\User::userIsAllowedTo('Manage AWPB activity lines')) {
                if (\backend\models\User::userIsAllowedTo('Approve AWPB - PCO') && ($user->district_id == 0 || $user->district_id == '')) {
