...
<div class="card card-success card-outline">
    ...
    <p>
            ...
            <?php
             echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['mpcma', 'id' => $model->activity_id,'district_id' => $model->district_id,'awpb_template_id'=>$model->awpb_template_id], [
                'title' => 'back',
                'data-toggle' => 'tooltip',
                'data-placement' => 'top',
            ]);
            ...
            // {          echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
            //     echo Html::a('Decline District AWPB',   ['decline', 'id' => $model->district_id],  ['class' => 'float-right btn btn-success btn-sm btn-space']);       
            // }
