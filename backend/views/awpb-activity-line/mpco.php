...
// }
       ...
       $gridColumns = [
        ...
        [
            ...
            'label' => 'Province',
            'value' => function ($model) {
                return !empty($model->province_id) && $model->province_id > 0 ?  Html::a(backend\models\Provinces::findOne($model->province_id)->name,['awpb-activity-line/mpcop','id' =>  $model->province_id,'awpb_template_id'=>$model->awpb_template_id], ['class' => 'awbp-activity-line']):"";
                ;
            },
        //     'visible' => !empty($model->district_id) && $model->district_id > 0 ? TRUE : FALSE,
         ],
            ...
            'buttons' => [
                ...
                'update' => function ($url, $model) {
                    if (User::userIsAllowedTo('Approve AWPB - PCO') ) {
                        return Html::a(
                                        '<span class="fas fa-edit"></span>',['submit','id'=>$model->awpb_template_id,'id2'=>$model->province_id,'status'=>AWPBActivityLine:: STATUS_APPROVED], [ 
                                    'title' => 'Approve AWPB',
                                    'data-toggle' => 'tooltip',
                                    'data-placement' => 'top',
                                    // 'target' => '_blank',
