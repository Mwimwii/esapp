        ...
        // ],
         ...
         [
            ...
            'value' => function ($model) {
                ...
                return Html::a($name, ['awpb-activity-line/mpwma', 'id' => $model->activity_id,'id2'=>$model->awpb_template_id], ['class' => 'awbp-activity-lined']);
            },
            ...
            'buttons' => [
                ...
                'update' => function ($url, $model) {
                    if (User::userIsAllowedTo('Approve AWPB - Ministry') ) {
                        return Html::a(
                                        '<span class="fas fa-edit"></span>',['submitpw','id'=>$model->awpb_template_id,'id2'=>$model->province_id,'status'=>AWPBActivityLine:: STATUS_MINISTRY], [ 
                                    'title' => 'Approve AWPB',
                                    'data-toggle' => 'tooltip',
                                    'data-placement' => 'top',
                                    // 'target' => '_blank',
