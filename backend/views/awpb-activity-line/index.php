       ...
       $gridColumns = [
        ...
        [
            ...
            'value' => function ($model) {
                ...
                return Html::a($name, ['awpb-activity-line/view', 'id' => $model->id], ['class' => 'awbp-activity-line']);
            },
        ...
        [
            ...
            [
               ...
               // 'refreshGrid' => true,
                ...
                'value' => function ($model, $key, $index, $widget) { 
                    ...
                    return $widget->col(5, $p)+$widget->col(6, $p)+$widget->col(7, $p) + $widget->col(8, $p);
                },
                'headerOptions' => ['class' => 'kartik-sheet-style'],
                'hAlign' => 'right', 
                'width' => '7%',
            ...
            [
                ...
                'value' => function ($model, $key, $index, $widget) { 
                    $p = compact('model', 'key', 'index');
                    return $widget->col(9, $p) != 0 ? $widget->col(4, $p) * $widget->col(9, $p) : 0;
                },
                'format' => ['decimal', 2],
                'headerOptions' => ['class' => 'kartik-sheet-style'],
                'mergeHeader' => true,
