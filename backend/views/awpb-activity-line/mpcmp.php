...
//$this->params['breadcrumbs'][] = ['label' => 'Provincial AWPB', 'url' => ['index']];
...
echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['awpb-activity-line/mpcm','id'=>$awpb_template_id], [
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
       ...
       [
        'attribute' => 'district_id',
            ...
            'value' => function ($model) {
                return !empty($model->district_id) && $model->district_id > 0 ?  Html::a(backend\models\Districts::findOne($model->district_id)->name,['mpcmd','id' =>  $model->district_id,'awpb_template_id'=>$model->awpb_template_id], ['class' => 'mpcmd']):"";
                ;
            },
        ...
        //         return Html::a($name, ['awpb-activity-line/mpca', 'id' => $model->activity_id,'district_id'=>$model->district_id,'awpb_template_id'=>$model->awpb_template_id], ['class' => 'awbp-activity-lined']);
        //     },
    ...
    <div class="modal-dialog modal-lg">
       ...
       ?>
        <?php
           ...
           echo $form->field($_model, 'province_id')->hiddenInput(['value'=> $id])->label(false);
