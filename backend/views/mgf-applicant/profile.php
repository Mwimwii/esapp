...
<div class="row">
    ...
    <div class="col-md-3">
            <?= Html::a('Logout<i class="glyphicon glyphicon-log-out"></i>', ['/mgf-applicant/profile'], ['class' => 'btn btn-link']) ?><br/>
            <?= Html::a('Profile<i class="glyphicon glyphicon-user"></i>', ['/mgf-applicant/applicant','id'=>$applicant->id], ['class' => 'btn btn-link']) ?> 
        <hr>
    </div>
</div>
...
<div class="row">
        ...
        <div id="accordionOrg">
            <div class="card">
                <div class="card-header" id="headingOrganisation">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOrg" aria-expanded="false" aria-controls="collapseOrg">
                            ...
                            <div class="col-md-2">
                                <div class="card-body">
                                    <?php if (MgfOrganisation::find()->where(['applicant_id'=>$applicant->id])->exists()) { ?>
                                        ...
                                        <?= Html::a('<i class="glyphicon glyphicon-pushpin"></i> Profile of the Organisation', ['/mgf-organisation/view','id'=>$applicant->organisation_id], ['class' => 'btn btn-link']) ?> <br/>
                                        <?= Html::a('<i class="glyphicon glyphicon-pushpin"></i> Business Management Capacity,<br/> Governance and Financial Status', ['/mgf-organisational-detail/create'], ['class' => 'btn btn-link']) ?> <br/>
                                        <?= Html::a('<i class="glyphicon glyphicon-pushpin"></i> Previous Experience with<br/> External Project Financing', ['/mgf-experience/view','id'=>$experience->id,'status'=>0], ['class' => 'btn btn-link']) ?> <br/>
                                        ...
                                        <?= Html::a('<i class="glyphicon glyphicon-pushpin"></i> Information Confirmation', ['/mgf-applicant/confirm','id'=>$applicant->id], ['class' => 'btn btn-link']) ?> <br/>
    ...
    <div class="col-md-6">
        ...
        <div style="text-align: center; font-weight:bold">Use of FPP</div>
            ...
            <?= Html::a('View Full Proposal Documents<i class="glyphicon glyphicon-info"></i>', ['/mgf-applicant/documents'], ['class' => 'btn btn-info']) ?> 
