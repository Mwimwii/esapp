...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <?php if($applicant->district_id>0){?>
            <?= $form->field($model, 'applicant_type')->dropDownList(['Category-A' => 'Category A', 'Category-B' => 'Category B'], ['disabled'=>true]) ?>
        <?php }else{ ?>
            <?= $form->field($model, 'applicant_type')->dropDownList(['Category-B' => 'Category B']) ?>
        <?php } ?>
