...
/* @var $searchModel backend\models\AwpbFunderSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'AWPB Funders';
    ...
    <div class="card-body">
        ...
        <p>
           ...
           if (User::userIsAllowedTo("Setup AWPB") ) {
               echo Html::a('<i class="fa fa-plus"></i> Add AWPB Funder', ['create'], ['class' => 'btn btn-success btn-sm']);
            }
            ?>
        </p>
