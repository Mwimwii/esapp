...
$this->title = 'Logframe / Project Goal Food Secure Households';
...
$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne(['record_type' => "Households - Percentage", 'indicator' => "Proportion of households that are food secure (M/F)"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label>  Proportion of households that are food secure (M/F)</li>
            <li>
                Log framework Programme target - Food Secure Household (%)
                <ul>
                    <?php
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                      ...
                      //  'pjaxContainerId' => 'kv-pjax-container',
                        ...
                        'filename' => 'logframe_project_goal_food_secure_households',
                        'dropdownOptions' => [
