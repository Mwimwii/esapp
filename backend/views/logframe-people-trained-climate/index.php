...
$this->title = 'Logframe / Output People Trained Climate Services records';
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label>  People trained in providing climate sensitive agribusiness advisory services (including Farming as a Business training)</li>
            <li>
...
//            ],
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                        ...
                        'filename' => 'logframe_output_people_trained_climate_services',
                        'dropdownOptions' => [
