...
$this->title = 'Introduction: ' . $model->title;
    ...
    <div class="card-body">
        <div class="tab-content" id="custom-tabs-two-tabContent">
            <div class="tab-pane fade show active" id="custom-tabs-two-home" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                <h5>Instructions</h5>
                <ol>
                    <li>Fill out the Story introduction below.Click "<span style="color: #007bff;">Story Check list</span>" above to complete the other details
                    </li>
                    <li>Click "<span class="badge badge-success">Save story introduction</span>" button to save the introduction
                    </li>
                </ol>     

                <div class="row">
                    <?php
                    $form = ActiveForm::begin(['action' => 'introduction?id=' . $model->id])
                    ?>
                    <div class="col-lg-8">
                        <p>
                            <b>The introduction (2-3 sentences summary of the case study or success story):</b> Offering a brief insight into the ‘story’ that will be told, including information such as the name of the person or group, the location, the date, the moment in the timeline of the programme, and where the story fits within the programme objectives:
                        </p>
                        <?=
                        ...
                        <div class="form-group">
                            <?= Html::submitButton('Save story introduction', ['class' => 'btn btn-success btn-sm']) ?>
