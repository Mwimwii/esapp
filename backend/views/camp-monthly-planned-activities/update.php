...
$this->title = 'Update Me Camp Subproject Records Monthly Planned Activities: ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Me Camp Subproject Records Monthly Planned Activities', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->id, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = 'Update';
?>
<div class="me-camp-subproject-records-monthly-planned-activities-update">
