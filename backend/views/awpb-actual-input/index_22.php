...
<div class="row" style="">
    ...
    <div class="col-lg-6">
        <h4>Instructions</h4>
        <ol>
            <li>Select the quarter you wish to request for funds from the list</li>
            <li>Click on filter to view the quarterly budget.</li>
...
<div class="row" style="">
    ...
    <div class="col-lg-5">
        ...
        //if ($funds_requisition->funds_request==0) {
         ...
         if ( $funds_requisition->status_q_1==\backend\models\AwpbDistrict::STATUS_QUARTER_REQUESTED && User::userIsAllowedTo('Approve Funds Requisition') &&( $user->province_id == 0 || $user->province_id == '') )
         {
         
              echo Html::a(
                        '<span class="float-right btn btn-success btn-sm btn-space">Approve request</span>', ['awpb-district/submit', 'id' => $id, 'id2' => $id2,'id3' => $id3,
                    'data-toggle' => 'tooltip',
                    'data-placement' => 'top',
                    // 'target' => '_blank',
                    'data-pjax' => '0',
...
<div class="row" style="">
    ...
    <div class="col-lg-4">
      ...
      if ($funds_requisition->funds_request==0) {
        ...
        if ($funds_requisition->funds_request==1) {
            echo Html::a(
                        '<span class="float-right btn btn-success btn-sm btn-space">Approve request</span>', ['awpb-district/submit', 'id' => $id, 'id2' => $id2,'id3' => $id3, 'status' => \backend\models\AwpbBudget:: STATUS_APPROVED], [
