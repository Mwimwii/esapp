...
$this->title = 'Quarterly Operations Funds Disbursement';
...
<div class="row" style="">
    ...
    <div class="col-lg-6">
        ...
        <ol>
            ...
            <li>Click on filter to view the approved request.</li>
           
            <li>Click on <i class="fa fa-check" style="color:blue"></i> to disburse the funds.</li>
<!--            if (!empty($sub)) {
...
[
    ...
    'detail' => function ($model, $key, $index, $column) use ($id){
        return Yii::$app->controller->renderPartial('index_3', ['id' => $id,'id2'=>$model->district_id,'quarter'=>'Q1']);
    },
    'headerOptions' => ['class' => 'kartik-sheet-style'] ,
    'expandOneOnly' => true
],
...
//],
     ...
     [
         ...
         if ($funds_requisition->status_q_1 == \backend\models\AwpbDistrict::STATUS_QUARTER_APPROVED){
                        ...
                        return Html::a(
                                        '<span class="fas fa-check"></span>',['awpb-district/submit','id'=>$model->awpb_template_id,'id2'=>$model->district_id,'id3'=>$id3,'status'=> \backend\models\AwpbDistrict::STATUS_QUARTER_DISBURSED], [ 
...
<div class="row" style="">
    ...
    <div class="col-lg-5">
        ...
        //  $query->join('LEFT JOIN', 'post', 'post.user_id = user.id');
            ...
            $query->select(['awpb_template_id', 'district_id', 'SUM(mo_1_amount) as mo_1_amount',  'SUM(mo_2_amount) as mo_2_amount',  'SUM(mo_3_amount) as mo_3_amount', 'SUM(quarter_one_amount) as quarter_one_amount']);
