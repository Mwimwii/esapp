...
$this->title = 'Logframe / Output Policies relevant products completed records';
...
$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne(['record_type' => "Policies - Number", 'indicator' => "Policy 1 - Number of policy-relevant knowledge products completed"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label> Policy 1 - Number of policy-relevant knowledge products completed</li>
            <li>
                Log framework Programme target - Number of Policies relevant products - Number
                <ul>
                    <?php
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                        ...
                        'filename' => 'logframe_outreach_household_members',
                        'dropdownOptions' => [
