...
$this->title = 'Logframe / Outreach Household Members';
...
$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne(['record_type' => "Household members - Number of people", 'indicator' => "1.b Estimated corresponding total number of households members"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label>  1.b Estimated corresponding total number of households members</li>
            <li>
                Log framework Programme target - Household members - Number of people
                <ul>
                    <?php
