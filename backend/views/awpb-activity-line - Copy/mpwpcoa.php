...
<?php
  echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['mpwpco', 'id'=>$id2], [
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
  ...
  {          echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
    ...
    echo '<button class="float-right btn btn-success btn-sm btn-space" href="#" onclick="$(\'#addNewModal\').modal(); 
                            return false;"></i> Decline PW AWPB </button>';
    }
            ...
            [
                ...
                [
                    ...
                    'urlCreator' => function($action, $model, $key, $index) { 
                            return Url::to(['viewpwpco','id'=>$key]);
                    },
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content card-success card-outline">
            ...
            <div class="modal-body">               <?php
                ...
                $form = ActiveForm::begin(['action' => Yii::$app->urlManager->createUrl(['awpb-activity-line/declinepwpco','id2'=>$id2, 'id'=>$id]),])
       ...
       ?>
        <?php
           ...
           echo $form->field($_model, 'awpb_template_id')->hiddenInput(['value'=>$id2])->label(false);
