        ...
        // ],
         ...
         [
            ...
            'value' => function ($model) {
                ...
                return Html::a($name, ['awpb-activity-line/mpcoa', 'id' => $model->activity_id,'district_id'=>$model->district_id,'awpb_template_id'=>$model->awpb_template_id], ['class' => 'awbp-activity-lined']);
            },
