...
echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['mpwm', 'id'=>$id2], [
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content card-success card-outline">
            ...
            <div class="modal-body">               <?php
                ...
                $form = ActiveForm::begin(['action' => Yii::$app->urlManager->createUrl(['awpb-activity-line/declinepwm','id2'=>$id2, 'id'=>$id]),])
