...
<div class="card card-success card-outline">
    ...
    <p>
            ...
            <?php
             echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['indexpw', 'id' => $model->awpb_template_id], [
                'title' => 'back',
                'data-toggle' => 'tooltip',
                'data-placement' => 'top',
            ]);
           // if (\backend\models\User::userIsAllowedTo('Manage AWPB activity lines')) {
                if (\backend\models\User::userIsAllowedTo('Manage programme-wide AWPB activity lines') && $user->district_id == 0 || $user->district_id == '') {
