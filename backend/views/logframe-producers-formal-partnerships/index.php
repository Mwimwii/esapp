...
$this->title = 'Logframe / Outcome Producers with formal partnerships records';
$this->params['breadcrumbs'][] = $this->title;
$Baseline = 0;
$mid_target = 0;
$end_target = 0;

$programme_targets_model = \backend\models\LogframeProgrammeTargets::findOne(['record_type' => "business arrangements - Number", 'indicator' => "2.2.3 Percentage of rural producers’ organizations engaged in formal partnerships/agreements or contracts with public or private entities"]);
...
<div class="card card-success card-outline">
    <div class="card-body">
        <p>
        <ol>
            <li><label>Indicator:</label>  2.2.3 Percentage of rural producers’ organizations engaged in formal partnerships/agreements or contracts with public or private entities</li>
            <li>
                Log framework Programme target - Business Arrangements - Number
                <ul>
                    <?php
        ...
        if (!empty($dataProvider) && $dataProvider->getCount() > 0) {
            ...
            $fullExportMenu = ExportMenu::widget([
                      ...
                      //  'pjaxContainerId' => 'kv-pjax-container',
                        ...
                        'filename' => 'logframe_outcome_business_arrangements',
                        'dropdownOptions' => [
