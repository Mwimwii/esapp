...
<div class="card card-success card-outline">
   ...
   <p>
            ...
            <?php
echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>',['mpcdo','status'=>$status,'district_id' =>  $district_id,'province_id'=>$province_id,'awpb_template_id'=>$awpb_template_id,'output_id' =>$output_id],[
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
...
//         
         ...
         [
            'label' => 'Indicator Description',
                  'value' =>  function ($model) {
                    $name = \backend\models\AwpbIndicator::findOne(['id' =>  $model->indicator_id])->description;
