...
<div class="card card-success card-outline">
   ...
   <p>
            ...
            <?php
   echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['index', 'id' => $awpb_template_id], [
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
    ...
    //  $status= \backend\models\AwpbBudget::STATUS_SUBMITTED;
        ...
        echo Html::a(
                '<span class="btn btn-success">Submit Provincial AWPB</span>', ['submit','id'=>$awpb_template_id,'id2'=>"",'status'=> backend\models\AwpbBudget:: STATUS_REVIEWED], [
              ...
              //  echo $form->field($_model, 'district_id')->textInput(['maxlength' => true,'value'=>$distr,'class' => "form-control"]);
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <?= $form->field($_model, 'description')->textarea(['rows' => 11, 'placeholder' =>""])->label("Comment");?>
                    </div>
