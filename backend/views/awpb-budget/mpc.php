...
//$dataProvider="";
            ...
            if (User::userIsAllowedTo('Approve AWPB - Provincial') && $role == "Provincial" && ($user->province_id > 0 || $user->province_id != '')) {
                ...
                echo Html::a(
                        '<span class="fas fa-check"></span>', ['submit', 'id' => $id, 'id2' => $id2, 'status' => \backend\models\AwpbBudget:: STATUS_REVIEWED], [
    ...
    echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['mp', 'id' => $id], [
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
                echo Html::a(
                        '<span class="fas fa-check"></span>', ['submit', 'id' => $id, 'id2' => $id2, 'status' => \backend\models\AwpbBudget:: STATUS_APPROVED], [
            ...
            $gridColumns = [
                ...
                [
                    ...
                    'value' => function ($model) {
                        ...
                        return !empty($model->district_id) && $model->district_id > 0 ? Html::a(backend\models\Districts::findOne($model->district_id)->name, ['mpcd', 'status' => $status, 'district_id' => $model->district_id, 'province_id' => $model->province_id, 'awpb_template_id' => $model->awpb_template_id], ['class' => 'mpcd']) : "";
                        ;
                    },
                //     'visible' => !empty($model->district_id) && $model->district_id > 0 ? TRUE : FALSE,
                ],
...
<div class="modal fade" id="addNewModal">
    <div class="modal-dialog modal-lg">
        ...
        echo $form->field($_model, 'province_id')->hiddenInput(['value' => $id2])->label(false);
