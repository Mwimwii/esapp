                ...
                <div class="card card-success card-outline card-tabs">
                    <div class="card-header p-0 pt-1 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="activity-tab" data-toggle="pill" href="#activity" role="tabs" aria-controls="activity" aria-selected="true">Activities</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link " id="component-tab" data-toggle="pill" href="#component" role="tabs" aria-controls="component" aria-selected="false">Component</a>
                            </li>
...
if (!empty($template_model)) {
    ...
    $query->select(['awpb_budget.awpb_template_id', 'awpb_budget.id', 'cost_centre_id', 'province_id', 'district_id', 'camp_id', 'awpb_budget.activity_id',
        'SUM(quarter_one_amount) as quarter_one_amount', 'SUM(quarter_two_amount) as quarter_two_amount',
        'SUM(quarter_three_amount) as quarter_three_amount', 'SUM(quarter_four_amount) as quarter_four_amount',
...
//              'format' => 'raw'
        ...
        [
            ...
            'buttons' => [
                ...
                if((!empty($model->cost_centre_id)|| $model->cost_centre_id!=0)&& (empty($model->province_id)||$model->province_id==0))
                {
                    return Html::a(
                   ...
                   else if((empty($model->cost_centre_id)|| $model->cost_centre_id==0)&& (!empty($model->province_id)||$model->province_id!=0) 
                           && (empty($model->district_id)||$model->district_id==0))
                {
                 return Html::a(
                            '<span class="fa fa-eye"></span>', ['viewcspco', 'id' => $model->id, 'status' => $model->id], [
                        'title' => 'View AWPB Activity',
                        'data-toggle' => 'tooltip',
                        'data-placement' => 'top',
                        // 'target' => '_blank',
...
//                          }
                                            ...
                                            'buttons' => [
                                                'mpc' => function ($url, $model) use ($user, $template_model, $today) {
                                                    ...
                                                    return Html::a(
                                                        ...
                                                        'title' => 'View AWPB by Sub-component',
                                                        'data-toggle' => 'tooltip',
                                                        'data-placement' => 'top',
                                                        // 'target' => '_blank',
                                                        'data-pjax' => '0',
                            ...
                            <div class="tab-pane fade" id="financier" role="tabpanel" aria-labelledby="financier-tab">
                                ...
                                if (!empty($template_model)) {
                                    ...
                                    $searchModel = new \backend\models\AwpbTemplateActivity();
                                    $query = $searchModel::find();
                                    $query->select(['awpb_template_id', 'activity_id',
...
//                 return Html::a($name, ['awpb-template/view', 'id' => $model->awpb_template_id], ['class' => 'awbp-template']);
                                                ...
                                                return !empty($model->awpb_template_id) && $model->awpb_template_id > 0 ? backend\models\AwpbTemplate::findOne($model->awpb_template_id)->fiscal_year : "";
                                            },
                                            'filterType' => GridView::FILTER_SELECT2,
                                            'filter' => \backend\models\AwpbActivity::getAwpbActivitiesList($access_level),
                                            'filterWidgetOptions' => [
