...
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
        ...
        echo Html::a(
                '<span class="fa fa-edit"></span>', ['updatecspco', 'id' => $model->id], [
            'title' => 'Update AWPB',
            'data-toggle' => 'tooltip',
            'data-placement' => 'top',
            'data-pjax' => '0',
  ...
  if ($model->total_amount<= 0)
        {
        echo Html::a(
                '<span class="fa fa-trash"></span>', ['deletecspco',  'id' => $model->id], [
           ...
           elseif (User::userIsAllowedTo('Manage AWPB') &&  
  ...
  if ($model->total_amount<= 0)
        {
        echo Html::a(
                '<span class="fa fa-trash"></span>', ['deletecspco'], [
            'title' => 'Delete AWPB Activity',
            'data-toggle' => 'tooltip',
            'data-placement' => 'top',
            'data' => [
