...
echo Html::a('<span class="fas fa-arrow-left fa-2x"></span>', ['mpcdoa', 'activity_id' => $model->activity_id,'output_id'=>$model->output_id, 'district_id'=>$model->district_id,'awpb_template_id'=>$model->awpb_template_id], [
    'title' => 'back',
    'data-toggle' => 'tooltip',
    'data-placement' => 'top',
]);
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
if (\backend\models\User::userIsAllowedTo('Manage AWPB')&& $model->district_id==$user->district_id) {
...
//                        ],
                        [
                            ...
                            'label' => 'No of women headed households',
                            'displayOnly' => true,
                            //'format' => ['decimal', 2],
                            'labelColOptions' => ['style' => 'width:15%'],
                            'valueColOptions' => ['style' => 'width:20%'],
                        ...
                        [
                            ...
                            'label' => 'No of non-women headed households',
                            'displayOnly' => true,
                            //'format' => ['decimal', 2],
                            'labelColOptions' => ['style' => 'width:15%'],
                            'valueColOptions' => ['style' => 'width:20%'],
...
//                        ],
                    ...
                    'buttons' => [
                        'view' => function ($url, $model) {
                            if ( $model->status == AwpbTemplate::STATUS_DRAFT && User::userIsAllowedTo('View AWPB')||User::userIsAllowedTo('Manage AWPB') ) {
                                return Html::a(
                        ...
                        'update' => function ($url, $model) {
                            if ($model->status == AwpbTemplate::STATUS_DRAFT && User::userIsAllowedTo('Manage AWPB') ) {
                                return Html::a(
