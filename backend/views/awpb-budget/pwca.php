...
//                        return $name->activity_code . ' ' . $name->name;
                           ...
                           return !empty($model->activity_id) && $model->activity_id > 0 ? Html::a(backend\models\AwpbActivity::findOne($model->activity_id)->name, ['pwcau', 'id' => $model->id,'status' => $model->id ], ['class' => 'mpcd']) : "";
