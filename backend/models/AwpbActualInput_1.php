...
class AwpbActualInput extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['component_id', 'activity_id', 'budget_id', 'name','unit_of_measure_id', 'unit_cost'], 'required'],
            [['activity_id', 'awpb_template_id', 'indicator_id', 'budget_id','input_id', 'status','unit_of_measure_id','cost_centre_id', 'camp_id','district_id', 'province_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
