...
/**
 * This is the model class for table "logframe_output_investments_prosmallholder_msme_matching_grants".
 *
 * @property int $id
 ...
 */
class LogframeOutputInvestmentsProsmallholderMsmeMatchingGrants extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'logframe_output_investments_prosmallholder_msme_matching_grants';
    }
    ...
    public function rules() {
        return [
            [['year', 'indicator', 'yr_target', 'yr_results',
            'cumulative', 'cumulative_percentage'], 'required'],
            [['indicator'], 'string'],
