...
/**
 * LogframeOutcomeHouseholdsImprovedAccessToMarketsSearch represents the model behind the search form of `backend\models\LogframeOutcomeHouseholdsImprovedAccessToMarkets`.
 */
class LogframeOutcomeHouseholdsImprovedAccessToMarketsSearch extends LogframeOutcomeHouseholdsImprovedAccessToMarkets
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeOutcomeHouseholdsImprovedAccessToMarkets::find();
