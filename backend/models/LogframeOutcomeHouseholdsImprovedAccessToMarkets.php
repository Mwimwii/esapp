...
/**
 * This is the model class for table "logframe_outcome_households_improved_access_to_markets".
 *
 * @property int $id
 ...
 */
class LogframeOutcomeHouseholdsImprovedAccessToMarkets extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'logframe_outcome_households_improved_access_to_markets';
    }
