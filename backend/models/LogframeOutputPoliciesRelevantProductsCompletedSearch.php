...
/**
 * LogframeOutputPoliciesRelevantProductsCompletedSearch represents the model behind the search form of `backend\models\LogframeOutputPoliciesRelevantProductsCompleted`.
 */
class LogframeOutputPoliciesRelevantProductsCompletedSearch extends LogframeOutputPoliciesRelevantProductsCompleted
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeOutputPoliciesRelevantProductsCompleted::find();
