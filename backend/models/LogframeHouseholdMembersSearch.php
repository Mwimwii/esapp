...
/**
 * LogframeHouseholdMembersSearch represents the model behind the search form of `backend\models\LogframeHouseholdMembers`.
 */
class LogframeHouseholdMembersSearch extends LogframeHouseholdMembers
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeHouseholdMembers::find();
