...
class MgfOrganisationSearch extends MgfOrganisation
{
    ...
    public function searchApplicationsAccepted1($params){
        ...
        if ($usertype=="Provincial user") {
            $provinceid=Yii::$app->user->identity->province_id;
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->joinWith('province')->joinWith('district')->where(['mgf_applicant.province_id'=>$provinceid,'application_status'=>'Accepted','mgf_applicant.applicant_type'=>'Category-A']);
         }else{
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->where(['application_status'=>'Accepted','mgf_applicant.applicant_type'=>'Category-A']);
        }
    ...
    public function searchApplicationsAccepted2($params){
        ...
        if ($usertype=="Provincial user") {
            $provinceid=Yii::$app->user->identity->province_id;
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->joinWith('province')->joinWith('district')->where(['mgf_applicant.province_id'=>$provinceid])->where(['application_status'=>'Accepted','mgf_applicant.applicant_type'=>'Category-B']);
         }else{
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->where(['application_status'=>'Accepted','mgf_applicant.applicant_type'=>'Category-B']);
        }
    ...
    public function searchApplicationsCertified1($params){
        ...
        if ($usertype=="Provincial user") {
            $provinceid=Yii::$app->user->identity->province_id;
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->joinWith('province')->where(['mgf_applicant.province_id'=>$provinceid,'application_status'=>'Certified','mgf_applicant.applicant_type'=>'Category-A'])->where(['mgf_applicant.province_id'=>$provinceid,'application_status'=>'Certified','mgf_applicant.applicant_type'=>'Category-A']);
        }else{
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->where(['application_status'=>'Certified','mgf_applicant.applicant_type'=>'Category-A']);
        }
    ...
    public function searchApplicationsCertified2($params){
        ...
        if ($usertype=="Provincial user") {
            $provinceid=Yii::$app->user->identity->province_id;
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->joinWith('province')->where(['mgf_applicant.province_id'=>$provinceid,'application_status'=>'Certified','mgf_applicant.applicant_type'=>'Category-B']);
        }else{
            $query = MgfOrganisation::find()->joinWith('applicant')->joinWith('mgfApplications')->where(['application_status'=>'Certified','mgf_applicant.applicant_type'=>'Category-B']);
        }
