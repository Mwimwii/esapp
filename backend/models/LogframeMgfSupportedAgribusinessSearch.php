...
/**
 * LogframeMgfSupportedAgribusinessSearch represents the model behind the search form of `backend\models\LogframeMgfSupportedAgribusiness`.
 */
class LogframeMgfSupportedAgribusinessSearch extends LogframeMgfSupportedAgribusiness
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeMgfSupportedAgribusiness::find();
