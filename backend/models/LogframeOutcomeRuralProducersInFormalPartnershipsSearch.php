...
/**
 * LogframeOutcomeRuralProducersInFormalPartnershipsSearch represents the model behind the search form of `backend\models\LogframeOutcomeRuralProducersInFormalPartnerships`.
 */
class LogframeOutcomeRuralProducersInFormalPartnershipsSearch extends LogframeOutcomeRuralProducersInFormalPartnerships
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeOutcomeRuralProducersInFormalPartnerships::find();
