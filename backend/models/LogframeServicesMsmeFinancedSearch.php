...
/**
 * LogframeServicesMsmeFinancedSearch represents the model behind the search form of `backend\models\LogframeServicesMsmeFinanced`.
 */
class LogframeServicesMsmeFinancedSearch extends LogframeServicesMsmeFinanced
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeServicesMsmeFinanced::find();
