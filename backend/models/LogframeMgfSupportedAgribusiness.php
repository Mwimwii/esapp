...
/**
 * This is the model class for table "logframe_output_investment_supported_agribusiness_matchinggrants".
 *
 * @property int $id
 ...
 */
class LogframeMgfSupportedAgribusiness extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'logframe_output_investment_supported_agribusiness_matchinggrants';
    }
    ...
    public function rules() {
        return [
            [['year', 'indicator', 'yr_target', 'yr_results', 'cumulative', 'cumulative_percentage'], 'required'],
            [['indicator'], 'string'],
