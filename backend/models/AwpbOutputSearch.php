...
/**
 * AwpbOutputSearch represents the model behind the search form of `backend\models\AwpbOutput`.
 */
class AwpbOutputSearch extends AwpbOutput
{
    /**
     * {@inheritdoc}
     */
