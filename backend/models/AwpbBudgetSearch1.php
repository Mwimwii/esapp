...
class AwpbBudgetSearch extends AwpbBudget
{
    ...
    {
        return [
            [['id', 'component_id', 'output_id', 'activity_id', 'awpb_template_id', 'indicator_id', 'status', 'district_id', 'province_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['name'], 'safe'],
