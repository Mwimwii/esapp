...
/**
 * LogframeOutputAgribusinessStudiesSearch represents the model behind the search form of `backend\models\LogframeOutputAgribusinessStudies`.
 */
class LogframeOutputAgribusinessStudiesSearch extends LogframeOutputAgribusinessStudies
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeOutputAgribusinessStudies::find();
