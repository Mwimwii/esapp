 ...
 */
class AwpbInputSearch extends AwpbInput
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'activity_id', 'awpb_template_id', 'indicator_id', 'unit_of_measure_id', 'status', 'camp_id','district_id', 'province_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['name'], 'safe'],
