...
/**
 * LogframeHouseAssetsSearch represents the model behind the search form of `backend\models\LogframeHouseAssets`.
 */
class LogframeHouseAssetsSearch extends LogframeHouseAssets
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['year', 'indicator', 'yr_target', 'yr_results', 'asset', 'category', 'cumulative', 'cumulative_percentage'], 'safe'],
        ];
    }
    ...
    {
        $query = LogframeHouseAssets::find();
