...
/**
 * LogframeDevObjectivesProfitableprojectSupportSearch represents the model behind the search form of `backend\models\LogframeDeveObjectivesHouseholdProfitableprojectSupport`.
 */
class LogframeDevObjectivesProfitableprojectSupportSearch extends LogframeDeveObjectivesHouseholdProfitableprojectSupport
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeDeveObjectivesHouseholdProfitableprojectSupport::find();
