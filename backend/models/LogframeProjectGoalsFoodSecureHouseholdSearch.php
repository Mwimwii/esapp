...
/**
 * LogframeProjectGoalsFoodSecureHouseholdSearch represents the model behind the search form of `backend\models\LogframeProjectGoalsFoodSecureHousehold`.
 */
class LogframeProjectGoalsFoodSecureHouseholdSearch extends LogframeProjectGoalsFoodSecureHousehold
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = LogframeProjectGoalsFoodSecureHousehold::find();
