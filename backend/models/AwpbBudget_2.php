 ...
 */
//Model used by Provincial Officer
class AwpbBudget_2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['component_id', 'activity_id', 'province_id', 'district_id', 'awpb_template_id'], 'required'],
