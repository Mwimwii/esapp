...
--
-- Table structure for table `logframe_output_investments_prosmallholder_msme_matching_grants`
--

DROP TABLE IF EXISTS `logframe_output_investments_prosmallholder_msme_matching_grants`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `logframe_output_investments_prosmallholder_msme_matching_grants` (
  `id` int NOT NULL AUTO_INCREMENT,
  `year` varchar(5) NOT NULL,
  `indicator` text NOT NULL,
  `yr_target` varchar(45) NOT NULL,
...
-- Dump completed on 2022-01-26 23:59:20
