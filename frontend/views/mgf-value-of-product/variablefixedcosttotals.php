...
$ValueOfProduct=MgfVariableFixedCostTotals::find()->where(['proposal_id'=>$proposal->id])->one();
$this->title = 'Totals of variable and fixed costs by year';
?>
<div class="variablefixedcosttotals">
