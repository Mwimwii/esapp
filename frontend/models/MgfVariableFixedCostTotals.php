...
/**
 * This is the model class for table "mgf_variable_fixed_cost_totals".
 *
 * @property int $id
 ...
 */
class MgfVariableFixedCostTotals extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'mgf_variable_fixed_cost_totals';
    }
