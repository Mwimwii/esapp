...
/**
 * MgfProfitBeforeInterestTaxesController implements the CRUD actions for MgfProfitBeforeInterestTaxes model.
 */
class MgfProfitBeforeInterestTaxesController extends Controller
{
    /**
     * {@inheritdoc}
     */
