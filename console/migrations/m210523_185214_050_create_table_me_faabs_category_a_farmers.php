...
class m210523_185214_050_create_table_me_faabs_category_a_farmers extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable(
            ...
            [
                ...
                'age' => $this->integer(),
                'household_head_type' => $this->string()->defaultValue('Male headed')->comment('Female headed or Male headed'),
            ],
            $tableOptions
        );
