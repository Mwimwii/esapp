...
class m210523_185214_052_create_table_me_faabs_training_attendance_sheet extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable(
            ...
            [
                ...
                'household_head_type' => $this->string(45)->defaultValue('Male headed')->comment('Female headed or Male headed'),
